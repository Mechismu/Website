...
export default function Home({ setCurrScreen }) {
      ...
      <div className="who-we-are-wrapper">
        <div className="who-we-are-content-wrapper">
          ...
          <p className="who-we-are-sub-heading">
            ...
            the aspiring engineers who are racing fanatics, who design and build
            a formula prototype race car, will enter into international Formula
            Student competitions. Many teams from all over the world compete in
            Formula Student competitions. As a result, MECHISMU-Racing is
            Religion gain access to world-class engineering and encouraging the
            growth of engineering techniques among Indian students, who will be
            crucial to the country's technological innovation.
          </p>
        </div>
